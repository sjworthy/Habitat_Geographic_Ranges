...
# Save the plot
ggsave(filename = paste0("./Topo.Global.Null/Topo_Global_Null_plot_", i, ".png"),
       plot = plot_obj,
       width = 5, height = 5)

write.csv(df_plot, file = paste("./Topo.Global.Null/topo.global.dist_", i, ".csv"))
 }
}
...
write.csv(null_output, file = "./Topo.Global.Null/global.topo.null.999.results.csv")
