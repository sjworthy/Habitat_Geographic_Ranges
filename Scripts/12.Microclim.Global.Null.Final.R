...
for(i in 1:999){
  ...
  if (i %% 100 == 0) {
    ...
    # Save the plot
    ggsave(filename = paste0("./Microclim.Global.Null/Microclim_Global_Null_plot_", i, ".png"),
           plot = plot_obj,
           width = 5, height = 5)
...
write.csv(null_output, file = "./Microclim.Global.Null/global.microclim.null.999.results.csv")