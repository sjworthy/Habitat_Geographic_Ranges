...
intercept.plot = ggplot(microclim.results, aes(x = Intercept))+
  geom_density()+
  geom_vline(xintercept = 0.06071191, linewidth = 1.5) + # this is the global intercept
...
slope.plot = ggplot(microclim.results, aes(x = Slope))+
  geom_density()+
  geom_vline(xintercept = 0.0009420475, linewidth = 1.5) + # this is the global slope
  theme_classic(base_size = 20) +
  ylab("Density")
...
ggplot(microclim.results, aes(x = R2))+
  geom_density()+
  geom_vline(xintercept = 0.3821377, size = 1.5) + # this is the global R2
  theme_classic(base_size = 20) +
  ylab("Density")+
  xlab("R-squared")
