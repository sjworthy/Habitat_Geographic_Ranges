...
ggplot(topo.results, aes(x = Intercept))+
  geom_density()+
  geom_vline(xintercept = 0.07825661) + # global null value
  theme_classic()

ggplot(topo.results, aes(x = Slope))+
  geom_density()+
  geom_vline(xintercept = -6.267296e-05) + # global null value
  theme_classic()

ggplot(topo.results, aes(x = R2))+
  geom_density()+
  geom_vline(xintercept = 0.003126151) + # global null value
  theme_classic()
